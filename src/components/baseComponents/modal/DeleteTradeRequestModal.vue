    ...
    <dialog open>
      <div class="alpha">
        ...
        <div class="second-part">
          <p class="text-1">Delete Trade Request</p>
        ...
        <br/>
        <div class="btn">
          <button @click="deleteTrade">Delete</button>
...
export default {
  ...
  methods:{
    ...
    async deleteTrade() {
      await StoreUtils.dispatch(StoreUtils.actions.trade.deleteTrade, {
        tradeId: this.selectedItem
      })
