        ...
        <div class="form">
          <div class="signUp">
            ...
            <div class="form-group-3">
              <label style="color: #FFFFFF" class="id">Identification Card (Upload front of ID card for verification)</label>
              <input
                  type="file"
                  id="files"
                  name="files"
            ...
            <div class="form-group-3">
              <label style="color: #FFFFFF" class="id">Identification Card (Upload back of ID card for verification)</label>
              <input
                  type="file"
                  id="files2"
                  name="files"
...
<!--            <div v-if="error">{{ error }}</div>-->
            ...
            <div class="create-acc">
              <p class="create-text" style="color: #FFFFFF;">
