      ...
      <div class="section-1">
        ...
        <form @submit.prevent="showDialog" id="InteracFundingCard" class="dashboard-body-wrapper align-center">
          ...
          <div class="margin-top margin-medium">
            ...
            <div class="input-form-2">
              <input type="text"  v-model="model.walletAddress"  class="input-form-3" placeholder="walletAddress" required name="walletAddress" />
            </div>
          ...
          <p class="text-block-51" style="padding-top: 10px; color: #6c757d;" >
            Note: For security reasons, Assets Management Limited processes withdrawals by review once a day.
