...
<!--    <intro-message-modal  @close="hideDialog" v-if="isModalOpened === false && dialogIsVisible === true" />-->
    ...
    <div class="section-2">
      ...
      <div class="section-2-part-1">
        ...
        <div class="lawrence bottom">
          <p @click="toggleScreen5" class="trade-btn-5">Trade Commodities</p>
        </div>
      </div>
      ...
      <div class="section-3">
        ...
        <div class="section-3-content">
          <div class="content-1">
            <p class="content-1-text-1">Profits</p>
            <div>
              <p class="content-1-text-2">£ {{UserDetails.user.totalProfits | formatAmount2}}</p>
            </div>
          </div>
          <div class="content-2">
            <img src="@/assets/wallet-number-icon.svg" alt="wallet-balance-icon"/>
    ...
    <div v-show="this.screen1 === 'Commodities'"  class="separate">

      <div id="tradingview_gold-wrapper"
           style="position: relative;
         box-sizing: content-box;
         width: 98%;
         display: block;
         ...
         height: 560px;"
      >
        <iframe title="advanced chart TradingView widget" lang="en" id="tradingview_gold" frameborder="0" allowtransparency="true" scrolling="no" allowfullscreen="true" src="https://s.tradingview.com/widgetembed/?hideideas=1&amp;overrides=%7B%7D&amp;enabled_features=%5B%5D&amp;disabled_features=%5B%5D&amp;locale=en#%7B%22symbol%22%3A%22OANDA%3AXAUUSD%22%2C%22frameElementId%22%3A%22tradingview_gold%22%2C%22interval%22%3A%22D%22%2C%22hide_side_toolbar%22%3A%220%22%2C%22allow_symbol_change%22%3A%221%22%2C%22save_image%22%3A%221%22%2C%22studies%22%3A%22%5B%5D%22%2C%22theme%22%3A%22dark%22%2C%22style%22%3A%221%22%2C%22timezone%22%3A%22Etc%2FUTC%22%2C%22withdateranges%22%3A%221%22%2C%22show_popup_button%22%3A%221%22%2C%22studies_overrides%22%3A%22%7B%7D%22%2C%22utm_source%22%3A%22infiniteprotrades.com%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22chart%22%2C%22utm_term%22%3A%22OANDA%3AXAUUSD%22%2C%22page-uri%22%3A%22infiniteprotrades.com%2Findex.php%2Fuser%2FtradeGold%22%7D" style="width: 100%; height: 100%; margin: 0px !important; padding: 0px !important;"></iframe>
      </div>
      ...
      <form ref="myForm" class="form-part" @submit.prevent="placeTrade">
        ...
        <div class="form-header">
          <p style="font-weight: bold;color: #FFFFFF;">TRADE COMMODITIES - PLACE TRADE</p>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="tradingPair" id="tradingPair" required v-model="symbolTraded" >
            ...
            <option value="UKOIL">Brent Crude Oil (UKOIL)</option>
            <option value="NATGAS">Natural Gas (NATGAS)</option>
            <option value="COPPER">Copper (COPPER)</option>
            <option value="XPTUSD">Platinum (XPTUSD)</option>
            <option value="XPDUSD">Palladium (XPDUSD)</option>
            <option value="NGAS">Natural Gas (NGAS)</option>
            <option value="COFFEE">Coffee (COFFEE)</option>
            <option value="COTTON">Cotton (COTTON)</option>
            <option value="CORN">Corn (CORN)</option>
            <option value="SOYBEAN">Soybean (SOYBEAN)</option>
            <option value="WHEAT">Wheat (WHEAT)</option>
            <option value="SUGAR">Sugar (SUGAR)</option>
            <option value="BRENT">Brent Crude Oil (BRENT)</option>
            <option value="WTI">West Texas Intermediate Crude Oil (WTI)</option>
            <option value="ETHUSD">Ethanol (ETHUSD)</option>
            <option value="HEATOIL">Heating Oil (HEATOIL)</option>
            <option value="RB">Gasoline (RB)</option>
            <option value="RBG21">Gasoline (RBG21)</option>
            <option value="LCO">Brent Crude Oil (LCO)</option>
            <option value="BZ">Brent Crude Oil (BZ)</option>
            <option value="HOSX21">Heating Oil (HOSX21)</option>
            <option value="CL">Crude Oil (CL)</option>
            <option value="NG">Natural Gas (NG)</option>
            <option value="HO">Heating Oil (HO)</option>
            <option value="RBOB">Gasoline (RBOB)</option>
            <option value="AECO">Natural Gas (AECO)</option>
            <option value="DTE">Ethanol (DTE)</option>
            ...
            <option value="COPPER">Copper (COPPER)</option>
            <option value="ALUMINUM">Aluminum (ALUMINUM)</option>
            <option value="LEAD">Lead (LEAD)</option>
            <option value="NICKEL">Nickel (NICKEL)</option>
            <option value="ZINC">Zinc (ZINC)</option>
            <option value="TIN">Tin (TIN)</option>
            <option value="COCOA">Cocoa (COCOA)</option>
            <option value="COTTON">Cotton (COTTON)</option>
            <option value="ORANGE">Orange Juice (ORANGE)</option>
            <option value="SUGAR">Sugar (SUGAR)</option>
            <option value="COFFEE">Coffee (COFFEE)</option>
            <option value="CORN">Corn (CORN)</option>
            <option value="OATS">Oats (OATS)</option>
            <option value="RICE">Rice (RICE)</option>
            <option value="SOYBEANS">Soybeans (SOYBEANS)</option>
            <option value="SOYMEAL">Soybean Meal (SOYMEAL)</option>
            <option value="SOYOIL">Soybean Oil (SOYOIL)</option>
            <option value="WHEAT">Wheat (WHEAT)</option>
            <option value="BUNDS">German Bund (BUNDS)</option>
            <option value="GILTS">UK Gilt (GILTS)</option>
            <option value="BOBL">Eurex Euro Bund (BOBL)</option>
            <option value="BUND">Eurex Euro Bund (BUND)</option>
            <option value="TNOTE">10-Year T-Note (TNOTE)</option>
            <option value="UB">Ultra T-Bond (UB)</option>
            <option value="ZB">30-Year T-Bond (ZB)</option>
            <option value="ZN">10-Year T-Note (ZN)</option>
            <option value="ZT">2-Year T-Note (ZT)</option>
            <option value="ZF">5-Year T-Note (ZF)</option>
            <option value="GC">Gold (GC)</option>
            <option value="SI">Silver (SI)</option>
            <option value="HG">Copper (HG)</option>
            <option value="PL">Platinum (PL)</option>
            <option value="PA">Palladium (PA)</option>
            <option value="A6">Brent Crude Oil (A6)</option>
            <option value="B6">Gasoline (B6)</option>
            <option value="C6">Corn (C6)</option>
            <option value="H6">Heating Oil (H6)</option>
            <option value="L6">Crude Oil (L6)</option>
            <option value="O6">Oats (O6)</option>
            <option value="S6">Soybeans (S6)</option>
            <option value="W6">Wheat (W6)</option>
          </select>
        </div>
